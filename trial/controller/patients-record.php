...
$pr_id = $_GET['data'];
$c_trial_patient_record = $mysqli->query("SELECT * from c_trial_patient_record where pr_id ='$pr_id'");

$c_trial_findings = $mysqli->query("SELECT * from c_trial_findings ");
$c_trial_admission_record = $mysqli->query("SELECT * from c_trial_admission_record ");
...
if(isset($_POST['add-record'])){
	...
	$mysqli->query("INSERT INTO c_trial_findings (patient_id,f_chiefcomplaint ,f_historypresentillness, f_bp,f_rr,f_cr,f_temp,f_wt,f_pr,f_diagnosis,f_medication,f_nameofphysician,trial_id) 
...
if(isset($_POST['add-admission'])){
	...
	$mysqli->query("INSERT INTO c_trial_admission_record (ad_wardname,ad_admittedby ,ad_physician, ad_father,ad_mother,ad_chargetoaccount,ad_relationtopatient,ad_address,ad_number,ad_totalpayment,patient_id,trial_id) 
...
if(isset($_POST['update-admission'])){
	...
	$mysqli->query("UPDATE c_trial_admission_record SET 

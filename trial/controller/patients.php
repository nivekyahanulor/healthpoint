...
$c_trial_patient_record = $mysqli->query("SELECT * from c_trial_patient_record");
...
if(isset($_POST['add-patient'])){
	...
	$mysqli->query("INSERT INTO c_trial_patient_record (pr_lname ,pr_fname, pr_mname,pr_addrs,pr_age,pr_bdate,pr_bplace,pr_civilstat,pr_gen,pr_number,pr_religion,pr_occup,trial_id) 
...
if(isset($_POST['update-patient'])){
	...
	$mysqli->query("UPDATE c_trial_patient_record SET 
							pr_lname = '$lastname',
							pr_fname = '$firstname', 
							pr_mname = '$middlename',
							pr_addrs = '$address',

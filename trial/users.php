			 ...
			 <?php if(isset($_GET['updated'])){?>
			  <br>
			   <div class="oaerror info">
				<strong>Success!</strong> - User Details Updated!
			  </div>
			  <?php } if(isset($_GET['added'])){?>
			  <br>
			   <div class="oaerror info">
				<strong>Success!</strong> - User Details Added!
			  </div>
			  <?php }if(isset($_GET['deleted'])){?>
			  <br>
			   <div class="oaerror warning">
				<strong>Success!</strong> - User Details Deleted!
			  </div>
			  <?php } ?>
            <div class="card-body">
						  ...
						  <div class="modal-dialog" role="document">
							<div class="modal-content">
							  ...
							  <div class="row">
								...
								<div class="col-sm-12" id="fieldsphysician" <?php if( $user['su_position'] == 'Doctor'){} else{ ?>style="display:none;" <?php } ?>>
								<div style="margin-bottom:17px;">
								<div class="row no-gutters">
								  <div class="text-xs font-weight-bold text-secondary text-uppercase mb-1"> Field</div>      
								</div>
								<select name="field" class="form-control" id="trial_position" required>

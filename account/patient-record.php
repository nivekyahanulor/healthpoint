...
<?php include("nav.php");?>
<?php include("controller/c_patient_record.php");?>
       ...
       <!-- Findings Box -->
            <div  id="findings" class="col-xl-8 col-lg-4">
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                <div class="table">
                <table class="table table-bordered" id="table_only" cellspacing="0">
                  <thead>
                    <tr>
                  ...
                  <tbody>
					 <?php foreach($c_findings as $findings): ?>
						<tr>
                ...
                <div class="card-body">
			 <div class="table">
                <table class="table table-bordered" id="table_only1" cellspacing="0">
                  <thead>
                    <tr>
                  ...
                  <tbody>
					 <?php foreach($c_admission_record as $ads): ?>
						<tr>
